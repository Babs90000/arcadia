...
<main>
        <div class="container">
            ...
            <a href="../fonctionnalités/ajout_alimentation_animaux.php">Renseigner l'alimentation d'un animal</a><br>
<a href="../fonctionnalités/gestion_service.php">Modifier les services du zoo</a><br>
