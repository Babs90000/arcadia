      ...
      <div id="carouselExampleCaptions" class="carousel slide d-block mx-auto">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./site arcadia image/image slider/savane.jpg" class="<!-- d-block w-100 --> image_savane" alt="photo de la savane">
          ...
          <div class="carousel-item">
            <img src="./site arcadia image/image slider/panneaux solaires.jpg" class="<!-- d-block w-100 --> image_panneaux-solaires" alt="panneaux solaires">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="./site arcadia image/image slider/chimpanze_chez_veterinaire-9.webp" class="<!-- d-block w-100 --> image_chimpanze" alt="chimpanze qui se fait soigner">
            <div class="carousel-caption d-none d-md-block">
